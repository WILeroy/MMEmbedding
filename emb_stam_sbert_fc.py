...
from dataloader.dataset_emb import VTDataset
...
if __name__ == '__main__':
    ...
    partitioner = DataPartitioner(args.data_file, np.array(size_gpus)/np.sum(size_gpus), False)
