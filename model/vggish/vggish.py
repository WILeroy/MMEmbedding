...
class VGGish(VGG):
  def __init__(self,
    ...
    """
    args:
      parms_paths: list, [parms_paths[0] = vggish_pretrain_path
                          parms_paths[1] = pca_pretrain_path]
    """
    super().__init__(make_layers())
    if pretrained:
      state_dict = torch.load(parms_paths[0])
    ...
    if self.postprocess:
      ...
      if pretrained:
        state_dict = torch.load(parms_paths[1])
